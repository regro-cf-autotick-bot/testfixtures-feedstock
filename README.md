...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/testfixtures-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/testfixtures-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `testfixtures` can be installed with `conda`:
...
```
mamba install testfixtures
```

It is possible to list all of the versions of `testfixtures` available on your platform with `conda`:
...
```
mamba search testfixtures --channel conda-forge
```
...
mamba repoquery search testfixtures --channel conda-forge

# List packages depending on `testfixtures`:
mamba repoquery whoneeds testfixtures --channel conda-forge

# List dependencies of `testfixtures`:
mamba repoquery depends testfixtures --channel conda-forge
```
